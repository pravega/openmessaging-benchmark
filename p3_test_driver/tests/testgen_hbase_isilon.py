...
for repeat in range(0,1):
  for num_compute_nodes in [3]:
    for record_count in [num_compute_nodes * 500*1000*1000]: #, num_compute_nodes * 500*1000*1000]:

              hbase_splits = 10 * num_compute_nodes

              common_config = {
                  "column_family": "family",
                  "command_env": {"JAVA_HOME": "/usr/java/jdk1.7.0_67-cloudera"},
                  "flush_compute": False,
