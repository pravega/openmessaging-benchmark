...
bin/benchmark --drivers driver-pravega/pravega-standalone.yaml workloads/schema-registry/1p-1c-rate-5k-user-avro.yaml 2>&1 | tee test1.log && grep Aggregated test1.log