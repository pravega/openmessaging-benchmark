...
public class SerDeDemo {
    ...
    private EventStreamWriter<MyPojo> createWriter() {
        ...
        SchemaInfo schemaInfo = new SchemaInfo("serde", serializationFormat, ByteBuffer.wrap(url.toString().getBytes(UTF_8)),
    ...
    private EventStreamReader<Object> createReader() {
        ...
        String urlString = new String(schema.getSchemaData().array(), UTF_8);
